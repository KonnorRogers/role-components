declare const RoleOption_base: {
    new (...args: any[]): {
        ...
        readonly validationMessage: string; /** @type {string | null} */
 ...
 * @tagname role-option
 */
export default class RoleOption extends RoleOption_base {
    static get validators(): never[];
    static get properties(): {
        ...
        type: import("lit").PropertyDeclaration<any, any>;
        download: import("lit").PropertyDeclaration<any, any>;
        href: import("lit").PropertyDeclaration<any, any>;
        hreflang: import("lit").PropertyDeclaration<any, any>;
        ping: import("lit").PropertyDeclaration<any, any>;
        referrerpolicy: import("lit").PropertyDeclaration<any, any>;
        rel: import("lit").PropertyDeclaration<any, any>;
        target: import("lit").PropertyDeclaration<any, any>;
        role: {
            reflect: boolean;
        };
        name: {
     ...
     */
    linkAttributes: typeof linkAttributes;
    /**
    ...
    simulateLinkClick(): boolean | undefined;
    /**
     * @param {ReturnType<import("lit").html>} content
     */
    renderBase(content: any): import("lit").TemplateResult<1>;
...
declare const linkAttributes: readonly ["download", "href", "hreflang", "ping", "referrerpolicy", "rel", "target", "type"];
export {};
