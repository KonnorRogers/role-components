declare const RoleSelect_base: {
    ...
    new (...args: any[]): {
        ...
        scrollBy(x: number, y: number): void;
        scrollIntoView(arg?: boolean | ScrollIntoViewOptions | undefined): void;
        /** @type {HTMLElement} */ scrollTo(options?: ScrollToOptions | undefined): void;
        /** @type {HTMLElement} */ scrollTo(x: number, y: number): void;
        setAttribute(qualifiedName: string, value: string): void;
        setAttributeNS(namespace: string | null, qualifiedName: string, value: string): void;
        setAttributeNode(attr: Attr): Attr | null;
        setAttributeNodeNS(attr: Attr): Attr | null;
 ...
 * @tagname role-select
 */
export default class RoleSelect extends RoleSelect_base {
    ...
    static get validators(): import("form-associated-helpers/exports/types.js").Validator<HTMLElement & {
     ...
     * @type {HTMLButtonElement | HTMLInputElement | null}
     */
    triggerElement: HTMLButtonElement | HTMLInputElement | null;
    __listboxId: string;
    /**
     * @type {OptionObject[]}
     */
     ...
     * @type {null | OptionObject}
     */
    currentOption: null | OptionObject;
    /**
     ...
     * @type {null | OptionObject}
     */
    __rangeStartOption: null | OptionObject;
    /**
     * @type {boolean}
     */
     ...
     */
    multipleSelectionType: "automatic" | "manual";
    /**
     ...
     */
    handleMultipleEditableInput(event: InputEvent, triggerElement: HTMLButtonElement | HTMLInputElement): void;
    /**
     * @param {string} finalString
     * @param {InputEvent} event
     * @private
     */
    private __shouldSelectSuggestedOption;
    /**
     * @param {string} finalString
     * @param {InputEvent} event
     * @param {typeof this.selectedOptions} newSelectedOptions
     */
    __findSuggestedOption(finalString: string, event: InputEvent, newSelectedOptions: typeof this.selectedOptions): OptionObject | null;
    /**
     * @param {InputEvent} event
     * @param {HTMLButtonElement | HTMLInputElement} triggerElement
     */
    __handleConfirmInput(event: InputEvent, triggerElement: HTMLButtonElement | HTMLInputElement): void;
    /**
     * @param {InputEvent} event
     * @param {HTMLButtonElement | HTMLInputElement} triggerElement
     * @private
     */
    private __handleAutomaticInput;
    /**
     * @param {InputEvent} event
     * @param {typeof this.triggerElement} triggerElement
     */
    handleSingleEditableInput(event: InputEvent, triggerElement: typeof this.triggerElement): void;
    /**
     * @param {RoleOption} el
     * @returns {OptionObject}
     */
    optionElementToOptionObject(el: RoleOption): OptionObject;
    /**
     * @param {{target: null | RoleOption}} event
     */
    handleOptionFocus(event: {
        target: null | RoleOption;
    }): void;
    /**
     * @param {Event} e
     */
     ...
     */
    assignRandomId(el: HTMLElement, id?: string): void;
    get listbox(): Element | null;
    get isEditable(): boolean;
    /**
     * Adds proper attributes to the slotted listbox element
     */
    updateListboxElement(): void;
    /**
     * @param {Event} e
     */
    ...
    renderSelectedOptions(): import("lit").TemplateResult<1>;
    get shouldShowEmptyResults(): boolean;
     ...
     */
    get isEditableMultipleCombobox(): boolean;
    /**
     * @override
     ...
     * @param {OptionObject} option
     */
    setCurrent(option: OptionObject): void;
    /**
     * @param {OptionObject} option
     */
    removeCurrent(option: OptionObject): void;
    /**
     * @param {OptionObject} option
     * @returns {RoleOption | null}
     */
    findOptionElement(option: OptionObject): RoleOption | null;
    /**
    ...
    get currentFocusableOptionIndex(): number;
    /**
     ...
     * @param {OptionObject} option
     */
    select(option: OptionObject): void;
    /**
     * @param {OptionObject} option
     */
    deselect(option: OptionObject): void;
    /**
     ...
     */
    deselectAll(updateOptions?: boolean): void;
    /**
     * @param {OptionObject} option
     */
    toggleSelected(option: OptionObject): void;
    focusCurrent(): void;
    get focusableOptions(): OptionObject[];
    /**
     * @param {number} index
     */
     ...
     * @return {void}
     */
    scrollOptionIntoView(selectedOption: OptionObject): void;
    /**
     * @param {HTMLElement} optionElement
     * @return {void}
     */
    scrollOptionElementIntoView(optionElement: HTMLElement): void;
    /**
     * @param {OptionObject} option
     * @return {boolean}
     */
    isSelected(option: OptionObject): boolean;
    /** @return {NodeListOf<HTMLOptionElement | RoleOption>} */
    get selectableOptions(): NodeListOf<HTMLOptionElement | import("../option/option.js").default>;
    /**
     * "completionSelected" is determined by if the user has an autosuggestion in the `<input>`.
     */
    get completionSelected(): boolean | null;
    updateOptions(): void;
    get multipleFormDataAndStringValue(): {
        formData: FormData;
        delimiterSeparatedValue: string;
        delimiterSeparatedContent: string;
    };
    /**
     * Updates formData / combobox.value
     * @param {boolean} [force=false]  - whether or not to force update a new value
     */
    updateMultipleValue(force?: boolean | undefined): void;
    updateCustomOption(): void;
    /**
     * @param {string} str
     */
    updateTriggerElementTextContentAndValue(str: string): void;
}
export type OptionObject = {
    ...
    content: string;
    /**
     * - Text to display in the `triggerElement`
     */
    displayValue: string;
    /**
